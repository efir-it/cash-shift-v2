...
Revision ID: e9a246960a8b
Revises: 
Create Date: 2023-09-15 12:49:31.953848
...
def upgrade() -> None:
    ...
    sa.Column('type_payment', sa.String(), nullable=False),
    sa.Column('check_status', sa.String(), nullable=False),
    sa.Column('type_taxation', sa.String(), nullable=False),
